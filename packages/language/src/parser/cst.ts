...
// `Origin` is IR-agnostic positional metadata owned by `@sirenpm/core`.
// Re-exported here so consumers of the parser CST types don't need a second
// import for positional metadata.
export type { Origin } from '@sirenpm/core';
