...
import { indexResourcesById } from '../../../../src/ir/normalization';
import type { Resource, ResourceType } from '../../../../src/ir/types';
import { buildDependencyGraph } from '../../../../src/utilities/milestone';
...
function completionOf(result: ImplicitCompletionResult, id: string): boolean | undefined {
  return result.resourcesById.get(id)?.complete;
}
