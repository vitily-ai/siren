...
describe('siren main', () => {
  ...
  it('list command outputs multiple circular dependency warnings', async () => {
    ...
    expect(consoleErrorSpy).toHaveBeenNthCalledWith(
      1,
      'siren/overlapping-cycles.siren:1:0: W004: Circular dependency detected: a -> b -> c -> a',
    );
    expect(consoleErrorSpy).toHaveBeenNthCalledWith(
      2,
      'siren/overlapping-cycles.siren:1:0: W004: Circular dependency detected: a -> c -> a',
    );
